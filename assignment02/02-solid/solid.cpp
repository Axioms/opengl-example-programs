...
const auto  number_of_vertices = 21;

void
init1(void)
{

    GLuint program = cs4722::compile_shaders("vertex_shader_solid.glsl","fragment_shader_solid.glsl" );
    ...
    glm::vec4 positions[] = {
            ...
            glm::vec4(radius*cos(2*M_PI/7), radius*sin(2*M_PI/7), 0, 1),
            glm::vec4(0,0,0,1),

            // BLUE
            glm::vec4(radius*cos(2*M_PI/7), radius*sin(2*M_PI/7), 0, 1),
            glm::vec4(radius*cos(4*M_PI/7), radius*sin(4*M_PI/7), 0, 1),
            glm::vec4(0,0,0,1),

            // BLACK
            glm::vec4(radius*cos(4*M_PI/7), radius*sin(4*M_PI/7), 0, 1),
            glm::vec4(radius*cos(6*M_PI/7), radius*sin(6*M_PI/7), 0, 1),
            glm::vec4(0,0,0,1),

            // YELLOW
            glm::vec4(radius*cos(6*M_PI/7), radius*sin(6*M_PI/7), 0, 1),
            glm::vec4(radius*cos(8*M_PI/7), radius*sin(8*M_PI/7), 0, 1),
            glm::vec4(0,0,0,1),

            // GRAY
            glm::vec4(radius*cos(8*M_PI/7), radius*sin(8*M_PI/7), 0, 1),
            glm::vec4(radius*cos(10*M_PI/7), radius*sin(10*M_PI/7), 0, 1),
            glm::vec4(0,0,0,1),

            // ORANGE
            glm::vec4(radius*cos(10*M_PI/7), radius*sin(10*M_PI/7), 0, 1),
            glm::vec4(radius*cos(12*M_PI/7), radius*sin(12*M_PI/7), 0, 1),
            glm::vec4(0,0,0,1),
    ...
    const cs4722::color colors[number_of_vertices] = {
        cs4722::x11::white, cs4722::x11::white, cs4722::x11::white,
        cs4722::x11::blue, cs4722::x11::blue, cs4722::x11::blue,
        cs4722::x11::black, cs4722::x11::black, cs4722::x11::black,
        cs4722::x11::yellow, cs4722::x11::yellow, cs4722::x11::yellow,
        cs4722::x11::gray, cs4722::x11::gray, cs4722::x11::gray,
        cs4722::x11::orange, cs4722::x11::orange, cs4722::x11::orange,
        cs4722::x11::green, cs4722::x11::green, cs4722::x11::green,
    };
