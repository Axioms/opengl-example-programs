...
init1(void)
{
    ...
    GLuint program = cs4722::compile_shaders("vertex_shader_gradient.glsl","fragment_shader_gradient.glsl" );
    ...
    glm::vec4 positions[] = {
            ...
            glm::vec4(radius*cos(2*M_PI/5), radius*sin(2*M_PI/5), 0, 1),
            glm::vec4(radius*cos(4*M_PI/5), radius*sin(4*M_PI/5), 0, 1),
            glm::vec4(radius*cos(6*M_PI/5), radius*sin(6*M_PI/5), 0, 1),
            glm::vec4(radius*cos(8*M_PI/5), radius*sin(8*M_PI/5), 0, 1),
            glm::vec4(radius, 0, 0, 1),
   };



    const cs4722::color colors[] = { cs4722::x11::white,
       cs4722::x11::blue, cs4722::x11::black, cs4722::x11::yellow,
       cs4722::x11::gray, cs4722::x11::orange, cs4722::x11::blue,
    };
